    ...
    <main className="bg-background-light">
      ...
      <section className="py-24 relative overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-gradient-to-br from-[#4C5869]/95 to-[#4C5869]/85" />
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                <Link
                  href="/portfolio"
                  className="inline-block bg-white text-[#4C5869] py-4 px-8 rounded-full font-medium hover:bg-gray-100 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-[1.02]"
                >
                  View Gallery
                </Link>
                <Link
